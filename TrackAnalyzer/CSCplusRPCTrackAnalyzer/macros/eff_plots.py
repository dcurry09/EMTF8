...
rpc_tg_eta.SetLineColor(kRed)
rpc_tg_eta.SetLineWidth(2)
rpc_tg_eta.SetMarkerStyle(23)
rpc_tg_eta.SetMarkerSize(0.8)
...
cEta.SetGridx()
cEta.SetGridy()
rpc_tg_eta.SetMinimum(0.0)
rpc_tg_eta.SetMaximum(1.02)
tg_eta.SetMinimum(0.0)
tg_eta.SetMaximum(1.02)
tg_eta.Draw('AP')
rpc_tg_eta.Draw('Psame')
cEta.Modified()
cEta.Update()

leg1 = TLegend(0.7, 0.4, 0.9, 0.6)
leg1.SetFillStyle(0)
leg1.SetBorderSize(0)
leg1.AddEntry(tg_eta, 'CSC',  'l')
leg1.AddEntry(rpc_tg_eta, 'CSC+RPC',  'l')
leg1.Draw('same')
...
rpc_tg_phi.SetLineColor(kRed)
rpc_tg_phi.SetLineWidth(2)
rpc_tg_phi.SetMarkerStyle(23)
rpc_tg_phi.SetMarkerSize(0.8)
...
cPhi.SetGridx()
cPhi.SetGridy()
rpc_tg_phi.SetMinimum(0.8)
rpc_tg_phi.SetMaximum(1.02)
tg_phi.SetMinimum(0.0)
tg_phi.SetMaximum(1.02)
tg_phi.Draw('AP')
rpc_tg_phi.Draw('Psame')
cPhi.Modified()
cPhi.Update()

leg3 = TLegend(0.7, 0.4, 0.9, 0.6)
leg3.SetFillStyle(0)
leg3.SetBorderSize(0)
leg3.AddEntry(tg_pt, 'CSC',  'l')
leg3.AddEntry(rpc_tg_pt, 'CSC+RPC',  'l')
leg3.Draw('same')
...
rpc_tg_pt.SetLineColor(kRed)
rpc_tg_pt.SetLineWidth(2)
rpc_tg_pt.SetMarkerStyle(23)
rpc_tg_pt.SetMarkerSize(0.8)
...
cPt.SetGridx()
cPt.SetGridy()
rpc_tg_pt.SetMinimum(0.0)
rpc_tg_pt.SetMaximum(1.02)
tg_pt.SetMinimum(0.0)
tg_pt.SetMaximum(1.02)
tg_pt.Draw('AP')
rpc_tg_pt.Draw('Psame')
cPt.Modified()
cPt.Update()

leg2 = TLegend(0.7, 0.4, 0.9, 0.6)
leg2.SetFillStyle(0)
leg2.SetBorderSize(0)
leg2.AddEntry(tg_pt, 'CSC',  'l')
leg2.AddEntry(rpc_tg_pt, 'CSC+RPC',  'l')
leg2.Draw('same')
