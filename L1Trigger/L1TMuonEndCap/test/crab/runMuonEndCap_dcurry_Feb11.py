...
process.TFileService = cms.Service(
    "TFileService",
    fileName = cms.string("root://eoscms//eos/cms/store/user/dcurry/EMTF/EMTF_effStudies_ZMu-PromptReco_v1.root")
    #fileName = cms.string("root://eoscms//eos/cms/store/user/dcurry/EMTF/EMTF_rateStudies_Run2015D_DoubleEG_RAW-RECO_v3.root")
    )
